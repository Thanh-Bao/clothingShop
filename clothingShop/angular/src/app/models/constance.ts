...
export const SAP_API_DOMAIN: string = "https://cors.baobaostore.com/https://backend.baobaostore.com/odata/v4/api"
...
export const TTDN_API: string = "https://cors.baobaostore.com/https://thongtindoanhnghiep.co/api"