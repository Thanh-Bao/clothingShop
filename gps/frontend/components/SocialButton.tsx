    ...
    <div>
      ...
      <div className="fixed bottom-[25%] max-[430px]:hidden left-4 z-20 ">
        <div className="w-44 h-12 flex bg-blue-600 rounded-full">
          <a
            href="#"
            className="text-white bg-red-500 hover:bg-blue-600 px-3 py-3 rounded-full flex items-center animate-ping"
            onClick={() => handleclick()}
          >
            <FontAwesomeIcon
              icon={faPhone}
          ...
          <span className="flex items-center pl-3 text-white font-bold">
            0866844225
          </span>
        </div>
      </div>
        ...
        <div className="popup z-20">
          <div className="popup-content z-20">
            <div className="w-[800px] h-[480px] max-[430px]:w-[400px] max-[430px]:h-[90%] max-[430px]:p-5 ">
              ...
              <div className="xl:flex">
                <div className="w-2/3 max-[430px]:w-full">
                  <div className="flex space-x-4 max-[430px]:justify-start max-[430px]:w-full">
                    ...
                    <div className="max-[430px]:w-1/2 max-[430px]:text-left">
                      ...
                      <p className="xl:flex xl:justify-start text-sm">
                        Ô tô & Xe máy
                      </p>
                    </div>
                  </div>
                    ...
                    <div className="space-y-2 mt-3">
                      ...
                      <div className="flex items-center">
                        ...
                        <p className="text-left">
                          Chi nhánh chính: Số 4B Đường 48, Phường Hiệp Bình Chánh, Thành Phố Thủ Đức, Thành Phố Hồ Chí Minh
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="w-1/3 max-[430px]:w-full">
                  <Image
                    ...
                    width={200}
                    height={200}
                    className="object-contain rounded-md mx-auto max-w-[200px] max-h-[200px] bg-amber-300"
                  />
              ...
              <div>
                <span className="flex justify-start max-[430px]:text-left">
                  THÀNH CÔNG GPS chuyên gia giải pháp trong lĩnh vực định vị
                  Ôtô:
                </span>
